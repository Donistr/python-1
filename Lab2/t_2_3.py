...
def partition_data_n_files_years_or_weeks(type_file: FunctionState, data_file_name: str = 'data_file.csv') -> None:
    """
    ...
    if type_file == FunctionState.partition_years:
        last_year = last_date.year
    else:
        if type_file == FunctionState.partition_weeks:
...
if __name__ == "__main__":
    partition_data_n_files_years_or_weeks(FunctionState.partition_years)
    partition_data_n_files_years_or_weeks(FunctionState.partition_weeks)
